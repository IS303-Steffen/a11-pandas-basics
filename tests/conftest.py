...
solution_module = "a10_solution_pandas_basics"
student_module = "a10_pandas_basics"
...
def format_error_message(custom_message: str = None,
    ...
    if input_test_case:
        ...
        error_message += insert_newline_at_last_space((
            ...
            f"\nFirst, read the error below. You can also check out the 'Rubric' and 'Input Test Cases' sections of the instructions.\n\n"
        ), line_length)
